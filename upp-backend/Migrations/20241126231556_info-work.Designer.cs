...
namespace upp.Migrations
{
    ...
    [Migration("20241126231556_info-work")]
    partial class infowork
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.AdditionalInfo", b =>
                {
                    ...
                    b.Property<int?>("CaloriesCountByDay")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("IsAvailableToWork")
            ...
            modelBuilder.Entity("upp.Entities.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("upp.Entities.ChatUser", b =>
                {
            ...
            modelBuilder.Entity("upp.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("upp.Entities.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("upp.Entities.ChatUser", b =>
                {
                    b.HasOne("upp.Entities.Chat", "Chat")
                        .WithMany("ChatUsers")
